...
export const SystemLogs: React.FC = () => {
    ...
    return (
        <div
            className={`fixed bottom-4 left-4 z-50 transition-all duration-300 ease-in-out border border-surface-border rounded-lg bg-[#0d0d0d]/90 backdrop-blur-md shadow-2xl overflow-hidden font-mono text-[10px] md:text-xs ${isExpanded ? 'w-[calc(100vw-2rem)] md:w-96 h-64' : 'w-auto h-auto'}`}
        >
            {/* Header / Toggle */}
            <div
