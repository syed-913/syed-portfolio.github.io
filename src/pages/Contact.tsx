...
import { Send, Terminal, Mail, MapPin, Github, Linkedin, MessageSquare, Award, MessageCircle } from 'lucide-react';
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <span className="text-white font-mono text-sm leading-relaxed block max-w-[200px]">
                                        For security reasons, my email is hidden. Please use the terminal form to reach out directly!
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <span className="text-white font-mono">Karachi, Pakistan</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-4 mt-2">
                                        <a href="https://github.com/syed-913" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" title="GitHub"><Github className="w-5 h-5" /></a>
                                        <a href="https://www.linkedin.com/in/syed-ammar-hussain/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" title="LinkedIn"><Linkedin className="w-5 h-5" /></a>
                                        <a href="https://discord.gg/G3ABYfxg" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" title="Discord"><MessageCircle className="w-5 h-5" /></a>
                                        <a href="https://www.credly.com/users/syed-ammar-hussain.913" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" title="Credly"><Award className="w-5 h-5" /></a>
                                    </div>
                                </div>
                            </div>
                        </div>
